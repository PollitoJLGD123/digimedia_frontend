...
const Page = () => {
  return (
    <>
      ...
      <main className="flex flex-col justify-center bg-[url(/servicios/analisis-y-benchmarking/img-main.webp)] h-[100%] bg-cover bg-[30%] md:h-[calc(120vh-67px)] ">
        ...
        <div className='flex flex-col celular md:hidden bg-[#7b22b3] items-center h-[800px] mt-[380px] justify-start align-start w-full'>
          <div style={{
