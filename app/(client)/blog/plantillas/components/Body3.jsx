            ...
            <div className="flex flex-col xl:flex-col lg:gap-6">
                <div className="w-full">
                    <div className="mb-6 mt-5">
                        <h2 className="text-5xl text-center font-extrabold text-red-500">{data.titulo}</h2>
                        <p className="text-lg text-center text-gray-400 mt-2">{fecha}</p>
                    </div>
                ...
                <figure className='flex justify-center w-full mt-4 md:mt-4'>
                    <img
                        src={data.url_image ? (data.url_image.startsWith('http') ? data.url_image : `/blog/${data.url_image}`) : "/blog/blog-4.jpg"}
                        alt={data.titulo || "Imagen del artículo"}
                        className="w-80 xl:w-96 object-contain rounded-3xl shadow-lg border-2 border-red-500"
                    />
                </figure>
            </div>
