    ...
    <div className="relative lg:mx-48 bg-white text-black rounded-2xl shadow-[0px_10px_25px_rgba(0,0,0,0.15)] overflow-hidden">
      ...
      <div className="px-6 md:px-10 py-8">
        ...
        <div className="mt-12 border-t border-gray-200 pt-6">
          <h4 className="text-lg font-semibold text-gray-800 mb-4">Contenido relacionado</h4>
            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                  <span className="text-teal-600 font-medium">{item}</span>
                </div>
                <div className="flex-grow">
                  <p className="text-gray-700 font-medium">Artículo relacionado {item}</p>
                  <p className="text-gray-500 text-sm">Descubre más información</p>
                </div>
