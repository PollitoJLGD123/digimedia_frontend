export default function Header({
  ...
  return (
    <div
      className="w-full h-screen md:h-[80vh] relative flex items-center justify-center md:justify-end text-center px-6 sm:px-12 bg-cover bg-center bg-no-repeat"
