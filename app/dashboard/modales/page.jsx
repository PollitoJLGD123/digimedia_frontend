    ...
    <main className="p-4 md:p-6 flex flex-col w-full h-[100vh] bg-gray-50">
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Gestión de Modales</h1>
                  ...
                  {filteredData.length > 0 ? (
                    filteredData.map((modal) => (
                      <tr key={`${modal.id_modalservicio}-Row`} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{modal.nombre}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{modal.correo}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{modal.servicio.nombre}</td>
