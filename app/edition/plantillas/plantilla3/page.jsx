...
const PageContent = () => {
  return (
    <div className="min-w-[10rem] min-h-[10rem] w-auto h-auto max-w-[50rem] max-h-[50rem] bg-yellow-600 relative overflow-auto">
      {/* Header */}
      <div
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl text-white">
          ...
          <p className="text-sm text-gray-300 font-light">
            ...
            elit. Culpa id quis aperiam fugit, ipsum veniam ad eligendi enim
            tempora aspernatur!
          </p>
      ...
      <div className="container mx-auto px-4 py-6 relative bg-gradient-to-r text-black">
        ...
        <div className="bg-red-500">Body Prueba 3</div>
